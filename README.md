...
SendSprint now ships a yool/tuple runtime alongside the linear sprint flow:
...
- `sendsprint sprint resume <run_id>` — replay pending tuples from the append-only log
