...
7. **`architecture/ADR-001-example.md`** (e demais ADRs) — decisões arquiteturais e suas razões. Para runtime multi-stack, leia `architecture/ADR-009-cross-stack-runtime.md`.
